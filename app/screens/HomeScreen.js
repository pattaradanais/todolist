    ...
    <View style={styles.container}>
      ...
      <View style={{flex:8,  marginBottom:-10}}>
        ...
        <LinearGradient  colors={[ '#00334d','#005580']} start={[0,0]} end={[1,0]} style={styles.card}>
          <TouchableOpacity onPress={() => this.toList()} style={{flex:1}}>
            
           
           <View style={{flex:2, flexDirection:'row',paddingVertical:10,paddingHorizontal:25,alignItems:'center'}}>
             ...
             <View style={{flex:3 ,alignItems:'flex-end',justifyContent:'center',paddingTop:20}}>
